...
/** Approved MVP identity suite, organized by lockup and contrast tone. */
export const brandLogos = {
  primary: {
    verdant: `${logoDir}/mvp-primary-lockup-verdant.png`,
    dark: `${logoDir}/mvp-primary-lockup-dark.png`,
    white: `${logoDir}/mvp-primary-lockup-white.png`,
  },
  monogram: {
    verdant: `${logoDir}/mvp-monogram-verdant.png`,
    dark: `${logoDir}/mvp-monogram-dark.png`,
    white: `${logoDir}/mvp-monogram-white.png`,
  },
  wordmark: {
    verdant: `${logoDir}/mvp-wordmark-verdant.png`,
    dark: `${logoDir}/mvp-wordmark-dark.png`,
    white: `${logoDir}/mvp-wordmark-white.png`,
  },
  scriptLockup: {
    verdant: `${logoDir}/mvp-script-lockup-verdant.png`,
    dark: `${logoDir}/mvp-script-lockup-dark.png`,
    white: `${logoDir}/mvp-script-lockup-white.png`,
  },
  scriptMark: {
    verdant: `${logoDir}/mvp-script-mark-verdant.png`,
    dark: `${logoDir}/mvp-script-mark-dark.png`,
    white: `${logoDir}/mvp-script-mark-white.png`,
  },
